...
// но в данном алгоритме присутствует коэффициент уменьшающий количество итераций, за счёт начального значения j, оно всегда на единицу больше значения i,
// а при расчёте сложности, такие коэффициенты не учитываются
// поэтому сложность - O(n * n)
